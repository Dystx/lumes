  ...
  return (
    <AnimatePresence>
      {hasFilters && (
        ...
        >
          <div className="relative bg-[var(--ember-accent)] text-white shadow-[0_2px_8px_rgba(184,66,26,0.4)] rounded-full px-3 py-1.5 flex items-center gap-1.5 text-xs font-semibold active:scale-95 transition-transform">
            ...
            {/* Pulse ring */}
            <span className="absolute inset-0 rounded-full ring-2 ring-[var(--ember-accent)]/40 animate-pulse-ring pointer-events-none" aria-hidden="true" />
          </div>
        </motion.button>
      )}
    </AnimatePresence>
